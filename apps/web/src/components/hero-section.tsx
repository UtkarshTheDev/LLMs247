      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-sm border border-white/10 px-4 py-2 mb-8"
          >
            <Sparkles className="h-4 w-4 text-blue-400" />
            <span className="text-sm text-gray-300">The Future of AI Integration</span>
          </motion.div>
          ...
          >
            A single API key that gives you seamless access to every AI model — with routing, 
            key rotation, and zero downtime.
          </motion.p>
          ...
          >
            <Button 
              size="lg"
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-2xl shadow-blue-500/25 text-lg px-8 py-6 rounded-xl group"
